...
/**
* {@link module:onyx/MenuItem~MenuItem} is a button styled to look like a menu item, designed
* for use in an {@link module:onyx/Menu~Menu}. When the MenuItem is tapped, it tells the
* menu to hide itself and emits an [onSelect]{@link module:onyx/MenuItem~MenuItem#onSelect}
