/**
	A control that provides input styling. Any controls inside the
	InputDecorator will appear to be inside an area	styled as an input. Usually,
	an InputDecorator surrounds an <a href="#onyx.Input">onyx.Input</a>.

		{kind: "onyx.InputDecorator", components: [
			{kind: "onyx.Input"}
		]}
		
	You may also place other controls, such as buttons, to the right or left of
	the input control, e.g.:
	...
	decorator itself is sized, then its contents will likely need to be sized
	as well.
