/**
	_onyx.IntegerPicker_, a subkind of <a href="#onyx.Picker">onyx.Picker</a>, is used to
	display	a list of integers that can be selected, ranging from _min_ to _max_. It is meant 
	to be used in conjunction with an <a href="#onyx.PickerDecorator">onyx.PickerDecorator</a>.
	...
	To initialize the IntegerPicker to a particular value, set the _value_ property to
	the integer that should be selected.
