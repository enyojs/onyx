	...
	components: [
		{kind: "FittableRows", classes: "enyo-fit", components: [
			{kind: "onyx.Toolbar", classes: "toolbar", components: [
				...
				{name: "menu", classes: "menu", components: [
					{kind: "IconButton", classes: "menu-button", icon: "images/menu-icon-info.png", panel: "info", ontap: "togglePullout"},
					{kind: "IconButton", classes: "menu-button", icon: "images/menu-icon-bookmark.png", panel: "bookmark", ontap: "togglePullout"},
					{kind: "IconButton", classes: "menu-button", icon: "images/menu-icon-mylocation.png", ontap: "findCurrentLocation"}
				]}
			]},
